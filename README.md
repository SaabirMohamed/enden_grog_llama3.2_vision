...
####  Lets collaborate and make it an awsome tool to publish 

### A work in progress 
I started from your main to wrap  (used pear A.I to prompt and test, can use cursor aider whatever)

<img width="563" alt="Screenshot 2024-10-02 at 05 49 23" src="https://github.com/user-attachments/assets/922fe4f6-5da0-4a47-ae8c-a15be8ec7d70">

- with streamlit chat ui...
```python
...
let make it evolve into something cheap free and awesome...if you want to collaborate 
